...
HoverCarousel.prototype = {
    ...
    bind: function () {
        ...
        this.callbacks.onMouseMove = function (e) {
            if (_this.mouseMoveRAF)
                cancelAnimationFrame(_this.mouseMoveRAF);
            _this.mouseMoveRAF = requestAnimationFrame(_this.onMouseMove.bind(_this, e));
        };
    ...
    onMouseEnter: function (e) {
        ...
        this.animated = setTimeout(function () {
            _this.animated = null;
            _this.DOM.wrap.style.scrollBehavior = "auto";
        }, 200);
        return this;
    },
    ...
    onMouseMove: function (e) {
        ...
        this.DOM.scope.setAttribute("data-at", (this.prevMore ? "left " : " ") + (this.nextMore ? "right" : ""));
    }
};
var carouselElm = document.querySelector(".carousel");
new HoverCarousel(carouselElm, 1);
